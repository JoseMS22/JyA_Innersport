...
const links = [
  { href: "/seller/pos", label: "POS" },
  { href: "/seller/ventas", label: "Ventas" },
  // Más adelante podemos agregar: { href: "/seller/reportes", label: "Reportes" },
];

export function SellerMenu({ user, onLogout }: Props) {
      ...
      <header className="border-b border-[#e5e7eb] bg-white/95 backdrop-blur sticky top-0 z-40">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Logo / enlace a POS */}
            <Link href="/seller/pos" className="flex items-center gap-2">
              <Image
                src="/logo.png"
                alt="JYA Innersport"
                width={40}
